...
class NoteResourceIT {
    ...
    public static Note createEntity(EntityManager em) {
        Note note = new Note().createdAt(DEFAULT_CREATED_AT);
        return note;
    }
    ...
    public static Note createUpdatedEntity(EntityManager em) {
        Note note = new Note().createdAt(UPDATED_CREATED_AT);
        return note;
    }
    ...
    void putNewNote() throws Exception {
        ...
        updatedNote.createdAt(UPDATED_CREATED_AT);
    ...
    void fullUpdateNoteWithPatch() throws Exception {
        ...
        partialUpdatedNote.createdAt(UPDATED_CREATED_AT);
